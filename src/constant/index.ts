export const ResError = {
  ...
  USERNAME_INVALID :{code:"ADM0001", message:"Username must contain at least 4 characters"},
  FULLNAME_INVALID: {code: "ADM0002", message: "Fullname contains up to 50 characters"},
  EMAIL_INVALID:{code:"ADM0003", message:"Email cannot be blank or syntax incorrect"},
